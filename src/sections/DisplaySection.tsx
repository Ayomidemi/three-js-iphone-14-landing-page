...
const DisplaySection = () => {
  ...
  useLayoutEffect(() => {
    const t1 = gsap
      ...
      .fromTo(firstText.current, { x: 0 }, { x: '20%' }, 'key1')
      .fromTo(secondText.current, { x: 0 }, { x: '-20%' }, 'key1');
  ...
  return (
    <Section>
      ...
      <TextBlockLeft ref={container}>
        ...
        <Text>
          Together with the best system color management, colors are precisely
          calibrated to deliver an optimal viewing experience.
        </Text>
      </TextBlockLeft>

      <TextContainer>
        <MovingText ref={firstText}>Tougher then ever!</MovingText>
        <MovingText ref={secondText}>Every touch matters.</MovingText>
      </TextContainer>
    </Section>
  );
};
